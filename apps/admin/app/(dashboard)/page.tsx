...
import { ShoppingCart, IndianRupee, Bike, Store, BookOpen, Ticket } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const { data: activePromosCount } = useQuery<number>({
    queryKey: ['admin-active-promos-count'],
    queryFn: async () => {
