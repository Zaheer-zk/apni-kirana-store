...
interface AuthShellProps {
  ...
  subtitle?: string;
  children: ReactNode;
  /** Optional footer (e.g. "Already have an account? Log in"). */
  footer?: ReactNode;
}

/**
 * Centred, max-w-md card used by every auth screen. Mirrors the structure
 * of `apps/customer/components/AuthScaffold.tsx` so the mobile + web flows
