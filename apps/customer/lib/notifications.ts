...
export async function registerForPushNotifications(): Promise<string | null> {
  ...
  // Use FCM device push token (works for both iOS and Android with proper config)
  // For dev / Expo Go, use Expo's getExpoPushTokenAsync; for prod, getDevicePushTokenAsync.
