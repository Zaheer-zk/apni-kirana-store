...
/**
 * Form schemas for the driver auth screens. Mirrors
 * `apps/customer-web/lib/auth-schemas.ts` but adds the vehicle/licence step
 * specific to the driver onboarding flow.
 */
...
export const vehicleSchema = z.object({
  ...
  licenseNumber: z
    .string()
    .trim()
    .min(4, 'Enter a valid licence number')
    .transform((v) => v.toUpperCase()),
});
