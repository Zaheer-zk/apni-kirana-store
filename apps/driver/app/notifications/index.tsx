...
function pickIcon(n: AppNotification): IconBundle {
  ...
  if (/store|merchant|shop|pickup/.test(haystack)) {
    return {
  ...
  if (/driver|delivery|on the way|navigate|drop|route/.test(haystack)) {
    return {
      ...
      {query.isLoading ? (
        ...
        <View style={{ flex: 1, paddingTop: headerHeight }}>
          <EmptyState
            ...
            subtitle="Order alerts and earnings updates will show up here."
          />
        </View>
      ) : (
        <FlatList
