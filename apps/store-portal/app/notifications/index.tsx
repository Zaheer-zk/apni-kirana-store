...
function pickIcon(n: AppNotification): IconBundle {
  ...
  if (/driver|delivery|on the way|navigate|en.route/.test(haystack)) {
    return {
  ...
  if (/store|merchant|shop|inventory|stock/.test(haystack)) {
    return {
      ...
      {query.isLoading ? (
        ...
        <View style={{ flex: 1, paddingTop: headerHeight }}>
          <EmptyState
            ...
            subtitle="New orders and store updates will show up here."
          />
        </View>
      ) : (
        <FlatList
