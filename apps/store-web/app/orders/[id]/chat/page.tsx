...
// Per-order chat between the store and the order's customer/driver. Mirrors
// apps/store-portal/app/chat/[orderId].tsx — same /api/v1/chats endpoints and
// same socket events so messages sync across mobile and web.
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-9rem)] max-w-3xl flex-col gap-3">
      <header className="flex items-center gap-3">
        ...
        <Link
          href={`/orders/${chatQuery.data.orderId}` as never}
        ...
        <CardContent className="flex h-full flex-col p-0">
          ...
          >
            <textarea
              ...
              placeholder={canSend ? 'Type your message…' : 'Chat is read-only for this order.'}
              rows={1}
              maxLength={1000}
