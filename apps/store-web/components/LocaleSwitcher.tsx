...
/**
 * EN ↔ हि toggle for store-web. Persists choice in `NEXT_LOCALE` cookie
 * (1-year, SameSite=Lax) and `router.refresh()`es so the server re-renders
 * with the new message bundle.
 */
